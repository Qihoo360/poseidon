...
cmd="$HADOOP jar ${current_dir}/lib/docmeta-${version}.jar meta.DocMetaConfigured  $hdp_doc_src  $hdp_doc_dst $day ${current_dir}/etc/test_hdfs.json "
echo $cmd
$cmd
...
cmd="$HADOOP jar ${current_dir}/lib/index-${version}.jar InvertedIndex.InvertedIndexGenerate $hdp_src,$hdp_last_middle $hdp_dst $day ${current_dir}/etc/test_hdfs.json "
echo $cmd
$cmd
#
...
cmd="$HADOOP jar ${current_dir}/lib/indexmeta-${version}.jar meta.IndexMetaConfigured $hdp_dst/*gzmeta  $hdp_dst2 $day ${current_dir}/etc/test_hdfs.json "
echo $cmd
$cmd
